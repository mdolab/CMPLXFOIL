...
C
c      N4 =  IDES                             / 1000
c      N3 = (IDES - N4*1000                 ) / 100
c      N2 = (IDES - N4*1000 - N3*100        ) / 10
c      N1 = (IDES - N4*1000 - N3*100 - N2*10)
C
c      M = FLOAT(N4) / 100.0
c      P = FLOAT(N3) / 10.0
c      T = FLOAT(N2*10 + N1) / 100.0
C
      ANP = AN + 1.0
      DO 10 I=1, NSIDE
        FRAC = FLOAT(I-1)/FLOAT(NSIDE-1)
...
C
      IF      (N543 .ceq. 210) THEN
cc     P = 0.05
       M = 0.0580
       C = 361.4
      ELSE IF (N543 .ceq. 220) THEN
cc     P = 0.10
       M = 0.1260
       C = 51.64
      ELSE IF (N543 .ceq. 230) THEN
cc     P = 0.15
       M = 0.2025
       C = 15.957
      ELSE IF (N543 .ceq. 240) THEN
cc     P = 0.20
       M = 0.2900
       C = 6.643
      ELSE IF (N543 .ceq. 250) THEN
cc     P = 0.25
       M = 0.3910
       C = 3.230
      ELSE
